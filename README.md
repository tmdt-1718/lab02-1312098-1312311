...
* [x] Mỗi người dùng chỉ có thể đọc tin nhắn 1 lần duy nhất. (**1312311**)
* [x] Người dùng chỉ có thể đọc tin nhắn khi họ nằm trong danh sách người nhận. (**1312311**)

Yêu cầu **không bắt buộc**:
* [ ] Người dùng có thể gửi hình ảnh đính kèm theo thông điệp. (**MSSV**)
* [x] Người dùng có thể gửi tin nhắn đến nhiều người dùng cùng lúc. (**1312098**)
* [x] Người dùng có thể đăng nhập với Facebook. (**1312098**)
* [x] Người dùng có thể block người khác. Sau khi block, người dùng sẽ không nhận được tin nhắn từ người bị block gửi nữa. (**1312098**)
* [x] Người dùng có thể xóa người dùng khác ra khỏi danh sách bạn. (**1312098**)
* [x] Người dùng có thể unblock người dùng khác. (**1312098**)
* [x] Khi người dùng kéo xuống cuối trang, các tin nhắn tiếp theo sẽ tự động hiển thị hoặc có nút nhấn "Xem thêm tin nhắn" để nạp thêm danh sách tin nhắn. (**1312098**)
* [x] Người dùng sẽ nhận được email thông báo khi họ nhận được tin nhắn cùng với link để xem tin nhắn. (**1312098**)
* [x] Người dùng sẽ nhận được email khi người nhận đã đọc tin nhắn. (**1312098**)
...
![Video Walkthrough](gif-demo/demo-chucnang.gif)
